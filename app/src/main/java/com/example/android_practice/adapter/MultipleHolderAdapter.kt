...
class MultipleHolderAdapter(val dataList: ArrayList<HotelData>) :
    ...
    private class HeaderViewHolder(private val binding: HeaderItemViewBinding) :
    ...
    private class SimpleViewHolder(private val binding: SimpleViewItemBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(data: HotelData) {
            binding.hotel = data
            binding.executePendingBindings()
